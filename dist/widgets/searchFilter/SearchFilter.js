...
function SearchFilter(props) {
    ...
    var onFinish = function (values) {
        ...
        delete values.limit;
        var filteredValues = searchFilterHelper_1.removeUndefinedFields(values);
        var groupedValues = searchFilterHelper_1.groupRangeValues(filteredValues);
        var newParams = searchFilterHelper_1.getParamsForFields(groupedValues, fields).reduce(function (acc, val) {
