...
var DashboardGrid = function (props) {
    ...
    return (react_1.default.createElement(ResponsiveReactGridLayout, { className: "layout", cols: { lg: 12, md: 10, sm: 6, xs: 4, xxs: 2 }, rowHeight: 30, onLayoutChange: function (layout) {
