...
var FormModal = function (props) {
    var visible = props.visible, id = props.id, _a = props.title, title = _a === void 0 ? id ? "Detail" : "New" : _a, _b = props.noReuse, noReuse = _b === void 0 ? false : _b, _c = props.buttonModal, buttonModal = _c === void 0 ? false : _c, rest = __rest(props, ["visible", "id", "title", "noReuse", "buttonModal"]);
