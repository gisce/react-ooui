...
var Text = function (props) {
    ...
    return (react_1.default.createElement(Field_1.default, __assign({ required: required }, props), translatable ? (react_1.default.createElement(TranslatableText, { field: id, requiredClass: requiredClass, height: height })) : (react_1.default.createElement(TextArea, { disabled: readOnly || translatable, className: requiredClass, style: { height: height ? height + "px" : "100%" }, rows: 4, onBlur: elementHasLostFocus }))));
};
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(antd_1.Row, { gutter: 8, wrap: false },
                react_1.default.createElement(TextArea, { value: value, onChange: function (event) {
                    ...
                    }, id: field, className: requiredClass, rows: 4, onBlur: elementHasLostFocus })),
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { onClick: function () {
            ...
            react_1.default.createElement(TextArea, { value: value, onChange: function (event) {
                    ...
                    height: height ? height + "px" : "100%",
                    cursor: "pointer",
                }, id: field, disabled: true, className: requiredClass, rows: 4, onBlur: elementHasLostFocus })),
