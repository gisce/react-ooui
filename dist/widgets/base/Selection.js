...
var SelectionInput = function (props) {
    ...
    return (react_1.default.createElement(CustomSelect, { disabled: readOnly, onChange: onChange, value: value, optionFilterProp: "children", filterOption: function (input, option) { return option.children.toLowerCase().indexOf(input.toLowerCase()) >= 0; }, showSearch: true }, options));
};
