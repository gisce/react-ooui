...
/***/ "./src/widgets/Tree.tsx":
/*!******************************!*\
  !*** ./src/widgets/Tree.tsx ***!
  \******************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {

eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nvar react_1 = __importDefault(__webpack_require__(/*! react */ \"react\"));\nvar antd_1 = __webpack_require__(/*! antd */ \"antd\");\nfunction Tree(props) {\n    var limit = props.limit, items = props.items, columns = props.columns, total = props.total, onRequestPageChange = props.onRequestPageChange, page = props.page, loading = props.loading;\n    var columnsForTable = columns.map(function (column) {\n        var title = column.title, dataIndex = column.dataIndex, key = column.key, type = column.type;\n        var render = type === \"Boolean\"\n            ? function (booleanField) {\n                return react_1.default.createElement(antd_1.Checkbox, { defaultChecked: booleanField, disabled: true });\n            }\n            : undefined;\n        return {\n            title: title,\n            dataIndex: dataIndex,\n            key: key,\n            render: render,\n            sorter: function (a, b) {\n                if (a[key] < b[key])\n                    return -1;\n                if (a[key] > b[key])\n                    return 1;\n                return 0;\n            },\n        };\n    });\n    var from = (page - 1) * limit + 1;\n    var summary = loading ? (react_1.default.createElement(antd_1.Spin, null)) : (\"Showing registers from \" + from + \" to \" + (from - 1 + items.length) + \" of \" + total + \" registers\");\n    return (react_1.default.createElement(react_1.default.Fragment, null,\n        summary,\n        react_1.default.createElement(antd_1.Pagination, { total: total, defaultPageSize: limit, className: \"pb-5 pt-5\", showSizeChanger: false, onChange: onRequestPageChange }),\n        react_1.default.createElement(antd_1.Table, { columns: columnsForTable, dataSource: items, pagination: false, loading: loading })));\n}\nexports.default = Tree;\n\n\n//# sourceURL=webpack://react-ooui/./src/widgets/Tree.tsx?");
