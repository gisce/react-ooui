...
function ButtonWithBadge(props) {
    ...
    return (react_1.default.createElement("div", { style: { position: "relative" } },
        ...
        react_1.default.createElement(ButtonWithTooltip_1.default, { tooltip: t("search"), icon: react_1.default.createElement(icons_1.SearchOutlined, null), onClick: onClick, disabled: disabled, style: { width: 46, zIndex: 0 } })));
}
