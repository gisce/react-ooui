...
function AttachmentsButton(props) {
    ...
    return (react_1.default.createElement(DropdownButton_1.default, { icon: react_1.default.createElement(icons_1.LinkOutlined, null), disabled: disabled, label: "(" + attachments.length + ")", tooltip: "Attachments", items: __spreadArray([
